...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
        <div class="white-box text-end">
            <a href="<?= $adminBaseUrl ?>addclass" class="btn btn-success text-white">
    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="white-box">
            <div class="d-md-flex mb-3">
                <h3 class="box-title mb-0">All Classes</h3>
            </div>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td><?php
                                    echo '<span class="badge bg-primary me-1">' . $value['category'] . '</span>';
                                    ?></td>
                                <td><?php echo date('d M h:i A', strtotime($value['created_at'])); ?></td>
                                <td>
                                    <a href="<?= $adminBaseUrl ?>editclass?classid=<?= $value['id'] ?>" class="btn btn-info">
